...
public class GestureChallengeScene extends AbstractScene {
	...
	public GestureChallengeScene(AbstractMTApplication mtApplication, String name) {
		...
		//SHIELD CREATION
		PhysicsShield pS = new PhysicsShield(bigRadius, smallRadius, smallDef,bigDef,(float) coveredAngle, new Vector3D(app.width/2f,app.height/2f), app, world, 1.0f, 0.3f, 0.4f, scale);
