...
//	*/
	...
	public static void addAssistedDragJoint(World world, MTComponent comp, boolean isDynamic, float scale, HybridHelpPopUp h){
		final float worldScale = scale;
		final World theWorld = world;
		final HybridHelpPopUp help =  h;
				...
				public boolean processGestureEvent(MTGestureEvent ge) {
					...
					try{
						...
						case DragEvent.GESTURE_STARTED:
							help.setHelpMessage("Throw it to the goal",MTColor.AQUA);
							comp.sendToFront();
							body.wakeUp();
