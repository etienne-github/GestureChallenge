 ...
 *
 ***********************************************************************/
package popup.touch.gestureEvent;
 ...
 */
public class TapAndHoldCountEvent extends MTGestureEvent {
	...
	private int availableCursorsNumber;
	 ...
	 */
	public TapAndHoldCountEvent(IInputProcessor source, int id, IMTComponent3D targetComponent, InputCursor m, boolean holdComplete, Vector3D clickPoint, int holdTime, float elapsedTime, float elapsedTimeNormalized, int availableCursors) {
		...
		this.availableCursorsNumber = availableCursors;
	}
	
	
	public int getAvailableCursors(){
		return availableCursorsNumber;
	}
